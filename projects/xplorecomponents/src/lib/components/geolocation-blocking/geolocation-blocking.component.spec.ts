...
describe('GeolocationComponent', () => {
    ...
    let fixture: ComponentFixture<GeolocationBlockingComponent>;
    let component: GeolocationBlockingComponent;
    ...
    beforeEach(async () => {
        ...
        .overrideComponent(GeolocationBlockingComponent, {
      ...
      beforeEach(() => {
        fixture = TestBed.createComponent(GeolocationBlockingComponent);
