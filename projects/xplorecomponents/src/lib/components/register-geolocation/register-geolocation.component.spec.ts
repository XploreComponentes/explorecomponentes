...
describe('RegisterGeolocationComponent', () => {
  ...
  let fixture: ComponentFixture<RegisterGeolocationComponent>;
  let component: RegisterGeolocationComponent;
  ...
  beforeEach(async () => {
    ...
    .overrideComponent(RegisterGeolocationComponent, {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RegisterGeolocationComponent);
